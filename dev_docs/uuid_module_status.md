...
### Low Priority
1. **Sync** (2 schemas) - Internal sync tracking
2. **Referrals** (2 schemas) - Referral tracking
3. **Legal** (1 schema) - Consent logging
