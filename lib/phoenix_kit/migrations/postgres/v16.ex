defmodule PhoenixKit.Migrations.Postgres.V16 do
  @moduledoc """
  PhoenixKit V16 Migration: Session Fingerprinting
  ...
  @doc """
  Run the V16 migration to add session fingerprinting fields.
  """
  def up(%{prefix: prefix} = _opts) do
    ...
    alter table(:phoenix_kit_users_tokens, prefix: prefix) do
      ...
      add :user_agent_hash, :string, null: true
    end
