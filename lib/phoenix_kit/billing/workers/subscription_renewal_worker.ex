defmodule PhoenixKit.Billing.Workers.SubscriptionRenewalWorker do
  @moduledoc """
  ...
  config :my_app, Oban,
    ...
    plugins: [
      {Oban.Plugins.Cron,
       crontab: [
         {"0 6 * * *", PhoenixKit.Billing.Workers.SubscriptionRenewalWorker}
       ]}
    ]
  ```
  ...
  alias PhoenixKit.Billing.{PaymentMethod, Providers, Subscription, SubscriptionPlan}
  alias PhoenixKit.Billing.Workers.SubscriptionDunningWorker
