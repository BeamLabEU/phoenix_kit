defmodule PhoenixKit.Billing.Providers.Stripe do
  @moduledoc """
  Stripe payment provider implementation.

  This module implements the `PhoenixKit.Billing.Providers.Provider` behaviour
  ...
  Configure Stripe in your provider settings:
      ...
      # Or via Settings API:
      PhoenixKit.Billing.update_provider_config(:stripe, %{
        enabled: true,
        mode: "test",
        api_key: "sk_test_...",
  ...
  @behaviour PhoenixKit.Billing.Providers.Provider
  ...
  defp get_stripe_customer_id_for_user(user_id) do
    ...
    query =
      from pm in PhoenixKit.Billing.PaymentMethod,
