defmodule PhoenixKit.Billing.Providers do
  @moduledoc """
  ...
  alias PhoenixKit.Billing.Providers.Provider
  alias PhoenixKit.Settings

  @providers %{
    stripe: PhoenixKit.Billing.Providers.Stripe,
    paypal: PhoenixKit.Billing.Providers.PayPal,
    razorpay: PhoenixKit.Billing.Providers.Razorpay
  }
  ...
  ## Examples
      ...
      PhoenixKit.Billing.Providers.Stripe

      iex> Providers.get_provider("paypal")
      PhoenixKit.Billing.Providers.PayPal
