defmodule PhoenixKitWeb.Live.Modules.DBTransfer.Index do
  @moduledoc """
  Landing page for DB Transfer module.
  ...
  def mount(params, _session, socket) do
    ...
    config = DBTransfer.get_config()

    socket =
      socket
      |> assign(:page_title, "DB Transfer")
      |> assign(:project_title, project_title)
      |> assign(:current_locale, locale)
      |> assign(:current_path, Routes.path("/admin/db-transfer", locale: locale))
  ...
  def render(assigns) do
    ...
    <PhoenixKitWeb.Components.LayoutWrapper.app_layout
      ...
      page_title="{@project_title} - DB Transfer"
      ...
      <div class="container flex flex-col mx-auto px-4 py-6">
        ...
        <header class="w-full relative mb-8">
          ...
          <div class="text-center">
            <h1 class="text-4xl font-bold text-base-content mb-3">DB Transfer</h1>
        ...
        <%= if not @config.enabled do %>
          <div class="alert alert-warning mb-6">
            ...
            <span>
              DB Transfer module is disabled. Enable it in
        ...
        <div class="grid gap-6 md:grid-cols-2 max-w-4xl mx-auto">
          ...
          <div class={[
            ...
            <div class="card-body items-center text-center">
              ...
              <div class="card-actions">
                <.link
                  navigate={Routes.path("/admin/db-transfer/send", locale: @current_locale)}
          ...
          <div class={[
            ...
            <div class="card-body items-center text-center">
              ...
              <div class="card-actions">
                <.link
                  navigate={Routes.path("/admin/db-transfer/receive", locale: @current_locale)}
