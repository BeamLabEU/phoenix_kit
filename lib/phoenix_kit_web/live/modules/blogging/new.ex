defmodule PhoenixKitWeb.Live.Modules.Blogging.New do
  ...
  def handle_event("manual_slug", %{"value" => slug}, socket) do
    sanitized = Blogging.slugify(slug)
    current_form = Phoenix.Component.to_form_data(socket.assigns.form)

    {:noreply,
     socket
     |> assign(:slug_autogenerated?, false)
     |> assign(:last_generated_slug, socket.assigns.last_generated_slug)
     |> assign(:form, new_blog_form(Map.put(current_form, "slug", sanitized)))}
  end
