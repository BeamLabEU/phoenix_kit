defmodule PhoenixKit.Modules.Publishing.Web.New do
  @moduledoc """
  LiveView for creating a new blog workspace (publishing group).
  """
  ...
  def mount(_params, _session, socket) do
    ...
    socket =
      ...
      |> assign(
        :current_path,
        Routes.path("/admin/settings/publishing/new", locale: socket.assigns.current_locale_base)
      )
  ...
  def handle_event("update_new_group", %{"blog" => params}, socket) do
  ...
  def handle_event("add_group", %{"blog" => params}, socket) do
  ...
  def handle_event("type_changed", %{"type" => new_type}, socket) do
    ...
    {:noreply,
     ...
     |> assign(:form, new_blog_form(updated_params))}
  end

  # Also handle when type comes through the form
  def handle_event("type_changed", %{"blog" => %{"type" => new_type}}, socket) do
  ...
  defp assign_form_state(socket, params, auto_slug?, last_generated_slug, auto_item_names?) do
    ...
    |> assign(:form, new_blog_form(params))
  end
