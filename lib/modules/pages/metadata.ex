defmodule PhoenixKit.Modules.Pages.Metadata do
  ...
  @type metadata :: %{
          ...
          featured_image_uuid: String.t() | nil,
          created_at: String.t() | nil,
          created_by_uuid: String.t() | nil,
          created_by_email: String.t() | nil,
          updated_by_uuid: String.t() | nil,
  ...
  defp parse_frontmatter_lines(frontmatter) do
    ...
    metadata_map = %{
      ...
      featured_image_uuid: Map.get(metadata, "featured_image_uuid", default.featured_image_uuid),
      description: Map.get(metadata, "description"),
      created_at: Map.get(metadata, "created_at", default.created_at),
      created_by_uuid: Map.get(metadata, "created_by_uuid", default.created_by_uuid),
      created_by_email: Map.get(metadata, "created_by_email", default.created_by_email),
      updated_by_uuid: Map.get(metadata, "updated_by_uuid", default.updated_by_uuid),
