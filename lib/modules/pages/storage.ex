defmodule PhoenixKit.Modules.Pages.Storage do
  @moduledoc """
  Filesystem storage helpers for pages.

  Content is stored under:

      priv/pages/<group>/<YYYY-MM-DD>/<HH:MM>/<language>.phk
  ...
  alias PhoenixKit.Modules.Pages.Storage.Deletion
  alias PhoenixKit.Modules.Pages.Storage.Helpers
  ...
  @doc """
  Moves an entire pages group to the trash folder.
  """
  ...
  @doc """
  Renames a pages group directory on disk when the slug changes.
  """
