defmodule PhoenixKit.Modules.Pages.Web.PagesController do
  use PhoenixKitWeb, :controller

  alias PhoenixKit.Modules.Pages
  alias PhoenixKit.Modules.Pages.SimpleRenderer
  ...
  def show(conn, %{"path" => path}) do
    if Pages.enabled?() do
      ...
      with {:ok, html_content, metadata} <- SimpleRenderer.render_file_with_metadata(file_path),
  ...
  defp render_pages_not_found(conn) do
    ...
    case SimpleRenderer.render_file_with_metadata(Pages.not_found_file_path()) do
